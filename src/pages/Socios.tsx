...
const products = [
  { name: "H2 Profit 1000", desc: "Es una tecnología patentada única que controla el dispositivo EGR para mejorar la eficiencia de la limpieza. Un verdadero probador de EGR, la máquina también permite optimizar la búsqueda de fallos en las válvulas EGR al forzarlas a abrirse o cerrarse.", img: `${WP}/2024/12/H2 Profit-1000S-EGR-PILOT.png`, link: "/tienda/maquinas-descarbonizadoras/hy-calamine-1000s-egr-pilot" },
  ...
  { name: "H2 Profit 3000", desc: "Descarbonización de motores de hidrógeno se presenta como la mejor solución para la limpieza del motor de vehículos ligeros, vehículos comerciales ligeros, vehículos pesados de mercancías y autobuses, todo en una sola maquina.", img: `${WP}/2024/12/H2 Profit-3000S-EGR-PILOT.png`, link: "/tienda/maquinas-descarbonizadoras/hy-calamine-3000s-egr-pilot" },
];
