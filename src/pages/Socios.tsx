...
const products = [
  ...
  { name: "Carbon FAP Limpieza de filtros de partículas", desc: "Descubre la eficaz máquina limpiadora Carbon FAP, tu mejor aliada para mantener en óptimas condiciones los filtros de partículas, ya sean de gasolina o diésel.", img: `${WP}/2024/11/carbon-fap-ecologia-rentable.png`, link: "/tienda/maquinas-limpieza-filtro-particulas/carbon-fap" },
